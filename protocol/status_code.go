...
// StatusCode represents the status code in Guacamole protocol
...
const (
	...
	UpstreamNotFound StatusCode = 519
	...
	UpstreamUnavailable StatusCode = 520
	...
	SessionConflict StatusCode = 521
